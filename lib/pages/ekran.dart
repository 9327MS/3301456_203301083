...
class _ekranState extends State<ekran> with SingleTickerProviderStateMixin{
  ...
  cksu = ['Yazın 2-4 günde bir sulanmalıdır, kışın genellikle her 7-10 günde bir sulanır.Kullanılan su kireçli olmamalı ve çok soğuk olmamalıdır, tercihen oda sıcaklığında olmalıdır.Ametist bahçede açık havada yetiştiriliyorsa, sabahın erken saatlerinde veya akşam geç saatlerde sulanmalı, asla günün en sıcak saatlerinde ve güneş altında sulanmamalıdır.', 'Papatyanın toprağı ne çok kuru ne de çok sulu olmalıdır. Toprağın her zaman nemli olduğundan emin olmalısınız. Susuzluğa karşı dayanıklı bir bitkidir. Ancak fazla sulama yapmak çiçeğin solmasına neden olabilir.Çiçeğin sağlıklı bir gelişim göstermesi için 2-3 günde bir sulama işlemi yapmanız yeterli olacaktır.', 'Güzel çiçekler yetiştirmek için güllerin suya ihtiyacı vardır. Sık sulama yapmamız gerekir, özellikle  yazın haftada en az iki kere, kış aylarında ise haftada 1 kere sulanmalıdır. Yazın pazertesi ve perşembe kışın is pazertesi sulanabilir.', 'Zambak toprağının sürekli nemli kalması en iyisidir. İki günde bir sulama önerilmesinin yanında sıcak yaz aylarında sulama sıklığı ve miktarı artırılabilir. Aşırı sulama, çiçeğin solmasına sebebiyet vereceği için dikkat edilmelidir.', 'Lale çiçeği, suyu seven bir bitkidir. Fakat topak kurudukça sulama yapılmalıdır. Lale çiçeği haftada iki kere olmak kaydıyla üstten sulama yapılmalıdır. Özellikle yazın suya fazla ihtiyaç duymaktadır. Su toprağın her tarafını eşit şekilde ıslatmalısınız. Sulama miktarı çok yoğun olmamalı ve mümkünse aynı kap ile yapılmalıdır.', 'Gelişim ve çiçeklenme döneminde toprağın kurumasına izin vermemek, aşırı sulamadan kaçınmak gerekir. Toprağı kurumayacak şekilde nemli tutulmalıdır. 3-4 günde bir kontrol edilerek sulanır.', 'Genel olarak 4 ile 7 günde 1 olacak şekilde, toprağın her zaman nemli kalacağı bir süre seçilir ve bu sürede sulamalar yapılır. Kışın 7 günde 1 suluyorsanız yaz sıcakları geldiğinde bu süreyi 4 günde 1 olacak şekilde ayarlayabilirsiniz.', 'Barış çiçeğinin toprağı sürekli nemli tutulmalı, kurumasına izin verilmemeli. Bu nedenle yaz aylarında daha sık, kış aylarında ise haftada 1-2 kez olacak şekilde sulama yapılabilir. Ancak dikkat, çiçeklenme dönemleri olan ilkbahar ve sonbahar aylarında, çiçeklenmeye başlamasını istediğiniz zaman sulama sıklığını azaltın ve toprağın kurumasını bekleyip tamamen kuruyunca sulama yapın. Hatta bu süreçte daha az aydınlık bir alana taşıyın. Sulama ve ortam düzeni değişen bitkinizin 2 hafta içinde çiçeklenmeye başladığını göreceksiniz. Çiçeklenen bitkinizi yeniden eski düzeninde, hep toprağı nemli kalacak şekilde sulamaya özen gösterin. ',],
  ckbk = ['Saksıda yetiştirilecekse kesinlikle drenaj deliği olan bir saksı seçilmelidir. Optimum yetiştirme sıcaklığı ortalama 18 ° C, 13-16 ° Cnin altında, bitki acı çekiyor ve çiçeklenme duruyor. Soğuk akımlardan ve sıcaklıktaki ani değişikliklerden korkar. Büyüme aşamasında çiçeklenmeyi teşvik etmek için her 15 günde bir yüksek fosfor içeriğine sahip bir gübre ile gübrelenmelidir.', 'Papatya nın ekileceği saksı çok derin olmamalıdır. Saksıda papatya yetiştirmek için killi toprak tercih edebilirsiniz. Toprak sıkı ve sert olmalıdır. Papatyalar 2 yıllık çiçekler olduğundan saksı değişimi yapılmasına gerek yoktur.Bu çiçeğin, güneşi çok sevdiği için kapalı mekan yerine balkon, bahçe, teras gibi alanlarda yetiştirilmesi önerilir. Kuru ve nemli bölgelerde yetişebilir.', 'Gübreleme olarak, yılda bir veya iki defa gübre veya kompost uygulamak gerekebilir. Gülleri budamak gerekir. Aksi takdirde, aşırı büyük, odunsu ve hastalıklara duyarlı olacaklardır. Her yıl zayıf, hastalıklı veya yaşlı olan sürgünleri çıkarmanız gerekecektir. Kışın bulunacağı ortamın sıcaklığı 12 derece altına düşmemelidir.', 'Zambak, bakımı kolay bir çiçektir. Doğrudan güneş ışığına ihtiyaç duymaz. Dolayısıyla karanlık evlerde bile kolaylıkla yetiştirilebilir. Bununla birlikte, çok soğuk ve çok sıcak ortamı sevmez. Cereyan alan, kışın çok soğuk yazın ise çok sıcak olan ortamlarda sağlıklı gelişim gösteremez.', 'Lale çiçeği kışın oda sıcaklığı 12 derecenin altına düşmediği ortamda bakılmalıdır,Lale çiçeği, rüzgardan etkilenir. Bu nedenle rüzgardan korumak gerekir. Rüzgar çiçeği sallar ve köklere hava girip çiçeğin ölmesine sebebiyet verir. Lale çiçeğinin toprağı havaların artık sıcaklaşmaya başladığı dönemde Nisan ortalarında değiştirilebilir. Değişim yapacağınız zaman saksı boyutunuda bir derece olarak büyütebilirsiniz.Lale çiçeğine  aşırı sulama, rüzgarlı ortam, hava deliksiz saksı kullanımı,  kalitesiz ve verimsiz toprak kullanımı ve mantar gibi hastalıklar zarar vermektedir.', 'Mevsimlik çiçekler olduklarından toprak ve saksı değişimine ihtiyaç duyulmaz.Çok geniş olmayan bir saksı seçimiyle başlamak gerekir. Doğal gübreli, vitamin ve mineral oranı yüksek topraklar nergisler için uygundur. Nergisin büyüdüğü saksıyı yarı gölgeli ortamda bulundurmalısınız. Güneş ışığını şiddetli şekilde almamalıdır.', 'Orkide, güneş ışığını doğrudan almayı sevmez. Bu nedenle kendisini aydınlık ama doğrudan güneş ışığının gelmediği bir noktada konumlandırmanız gerekmektedir. Orkide saksısının şeffaf ve küçük olmasına özen göstermelidir. Saksıda drenaj deliklerinin bulunduğundan emin olun. Orkideye özel satılan toprak ve gübre tercih edilmelidir. Orkidenizin yerini sık sık değiştirmemeye özen gösterin. Oda sıcaklığının 15 ila 25 derece arasında olmasına da özen göstermeniz yararlı olacaktır.', 'Barış çiçeği her ortama oldukça kolay bir şekilde uyum sağlayabilen bir çiçektir. Gölge ve yarı gölge alanlardan hoşlanır. Direkt güneş ışığını sevmez. Toprağı torf ve lif bakımından zengin olmalıdır böyle çok daha verimli bir şekilde yetişir. Kendisi için en uygun sıcaklık aralığı ise 10 ila 28 derece arasında değişen sıcaklıklardır. Barış çiçeği yer değiştirmeyi çok sevmez, bu nedenle yaklaşık 2-3 yılda bir saksısını değiştirmeniz bile yeterli olacaktır.',],
  ckek = ['https://www.ciceksu.com/cicek-turleri/ametist-cicegi-browallia.html','https://www.yasemin.com/pratik-bilgiler/haber/2849157-papatya-nasil-yetistirilir-saksida-papatya-bakimi-papatya-cicegi-ozellikleri-ve-faydalari?ysclid=l3ymhzoyrj', 'https://www.bitkibakimi.com/cicek/286-gul-bitkisi-bakimi-ve-yetistirilmesi-hakkinda-genel-bilgiler.aspx', 'https://www.bitkibakimi.com/cicek/287-zambak-bitkisi-bakimi-ve-yetistirilmesi-hakkinda-genel-bilgiler.aspx', 'https://www.bitkibakimi.com/cicek/288-lale-bitkisi-bakimi-ve-yetistirilmesi-hakkinda-genel-bilgiler.aspx', 'https://www.evimdergisi.com.tr/nergis-cicegi-bakimi-sulamasi-ve-cogaltmasi-nasil-yapilir-anlami-nedir/', 'https://www.evimdergisi.com.tr/orkide-bakimi-nasil-yapilir-evde-orkide-nasil-cogaltilir/', 'https://www.evimdergisi.com.tr/baris-cicegi-bakimi-nasil-olmali-spat-cicegi-spatifilyum-ozellikleri/',],
  ckres =['assets/images/amtes.jpg','assets/images/papatya.png','assets/images/gül.jpg','assets/images/zambak.jpg','assets/images/lale.jpg','assets/images/nergis.jpg','assets/images/orkide.jpg','assets/images/barıs.jpg'];
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (context) => cknew())),
          ...
          child: Column(
           ...
           children: <Widget>[
             ...
             onHorizontalDragUpdate: (details) {
               ...
               else{Navigator.of(context).push(MaterialPageRoute(builder: (context) => cknew()));}
             },
